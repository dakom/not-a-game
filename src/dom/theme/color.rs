...
impl Color {
    pub const fn hex_str(self) -> &'static str {
        match self {
            Self::Darkest => "#11131A",
            Self::Accent => "#03ff7b",
            Self::AccentDarker => "#10ca60",
            Self::Whiteish => "#FCFAFA",
            Self::Darkish => "#45474F",
            Self::Grey => "#92949F",
    ...
    pub fn class(&self) -> &str {
        ...
        pub static BLUE: LazyLock<String> = LazyLock::new(|| {
            class! {
                .style("color", Color::Blue.hex_str())
            }
        });

        pub static BLUE_DARKER: LazyLock<String> = LazyLock::new(|| {
            class! {
                .style("color", Color::BlueDarker.hex_str())
            }
        });
    ...
    pub fn class_bg(&self) -> &str {
        ...
        pub static BLUE: LazyLock<String> = LazyLock::new(|| {
            class! {
                .style("background-color", Color::Blue.hex_str())
            }
        });

        pub static BLUE_DARKER: LazyLock<String> = LazyLock::new(|| {
            class! {
                .style("background-color", Color::BlueDarker.hex_str())
            }
        });
    ...
    pub fn class_border(&self) -> &str {
        ...
        pub static BLUE: LazyLock<String> = LazyLock::new(|| {
            class! {
                .style("border-color", Color::Blue.hex_str())
            }
        });

        pub static BLUE_DARKER: LazyLock<String> = LazyLock::new(|| {
            class! {
                .style("border-color", Color::BlueDarker.hex_str())
            }
        });
