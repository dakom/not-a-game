use crate::{prelude::*, enemy::data::EnemySpriteSheets, renderer::Renderer, media::Media, config::CONFIG, spritesheet::SpriteSheet};
...
impl EnemySpawner {
    pub fn new(renderer: &mut Renderer, media: &Media) -> Result<Self> {
        Ok(Self {
            ...
            launcher_sprite_sheet: SpriteSheet::new(renderer, &media.objects.launcher_img, &media.objects.launcher_info)?,
        })
    }
}